...
export default function About() {
    ...
    return (
        <main className="nexora container about-page nexora-base-theme" aria-labelledby="nexora-heading">
            <div className={isDemo ? 'block1' : undefined}>
                <div className="landing-breadcrumb-wrapper">
                    <Breadcrumb items={crumbs} />
                </div>

                <div className="about-intro" aria-labelledby="about-intro">
                    <h3>About Nexora Tech Consulting</h3>
