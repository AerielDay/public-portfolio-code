    ...
    <main className={`nexora case-studies-page nexora-base-theme ${isDemo ? 'demo-mode' : ''}`}>
      <div className={isDemo ? 'block1' : undefined}>
        ...
        <header className="case-studies-header" aria-labelledby="cs-heading">
          <h3 id="cs-heading">Case Studies</h3>
      ...
      <div className="case-studies-grid block2">
      ...
      <footer className="nexora-footer" style={{ background: "linear-gradient(to bottom, transparent 0%, transparent, #1e2b38 70%, #1e2b38 100%)" }} >
