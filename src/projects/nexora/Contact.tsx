...
export default function Contact() {
    ...
    return (
        <main className="nexora container contact-section nexora-base-theme" aria-labelledby="contact-heading">
            ...
            <footer className="nexora-footer nexora-base-theme" style={{ background: "transparent" }} >
                {/* <section className="nexora-base-theme nexora-footer-section" >
                        <footer className="nexora-footer" style={{ background: "transparent" }} > */}
