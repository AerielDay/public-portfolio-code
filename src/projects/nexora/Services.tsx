  ...
  return (
    <main className="nexora services-page nexora-base-theme">
      ...
      <section className={isDemo ? 'services-cta block2' : 'services-cta'} >
        ...
        <Link to={`${baseRoute}/contact`} className="btn-primary" style={{ transform: "translateY(-2px)" }}>Contact Our Team</Link>
      </section>


      <footer className="nexora-footer" style={{ background: "linear-gradient(to bottom, transparent 0%, #1e2b38 70%, #1f2b37 100%)" }}>
